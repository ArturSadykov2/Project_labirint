...
clock = pg.time.Clock()
level_texture = pg.image.load('ball.png').convert_alpha()
bg_texture = pg.image.load('image\main_backgroubd.png').convert_alpha()
bg_texture = pg.transform.scale(bg_texture, size)
level_texture = pg.transform.scale(level_texture, (500, 500))
bg_surface = pg.Surface(size, pg.SRCALPHA)
bg_surface.blit(bg_texture, (0, 0))
labirint_surface = pg.Surface((500, 500), pg.SRCALPHA)
